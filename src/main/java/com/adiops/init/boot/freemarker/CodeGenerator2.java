...
public class CodeGenerator2 {
	...
	public static void main(String[] args) throws Exception {		
		String appuser="com.adiops.apigateway.;app_user=>keyid:String:0,user_name:String:1,email:String:2,first_name:String:3,last_name:String:4,encrypted_password:String:5,enabled:Boolean:6";
